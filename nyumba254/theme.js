...
(function () {
  ...
  // Icon-only, before the hamburger, visible only at mobile widths (see the media query in
  // theme.css) — the version that worked well. Desktop has no visible toggle by design: the
  // choice made on a phone is remembered site-wide via localStorage.
